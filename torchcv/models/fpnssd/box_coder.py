...
class FPNSSDBoxCoder:
    def __init__(self):
        ...
        self.anchor_areas = (8*8., 16*16., 32*32., 64*64., 128*128., 256*256.)
        self.aspect_ratios = (1/2., 1/1., 2/1.)
        self.scale_ratios = (1., pow(2,1/3.), pow(2,2/3.))
        # self.anchor_boxes = self._get_anchor_boxes(input_size=torch.tensor([512.,512.]))
        self.anchor_boxes = self._get_anchor_boxes(input_size=torch.tensor([1024.,256.]))
    ...
    def nonlocal_matching(self):
        ...
        # label = torch.long(index.clone() + 1)
